                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group d-flex align-items-center">
                                              <?php if($a->flags == 0){?>
                                                  <a class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#switchAktif" data-id="<?=$a->idriwayat_pinjaman?>">
                                                                Approval
                                                            </a>
                                                               <a class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#switchNonAktif" data-id="<?=$a->idriwayat_pinjaman?>">
                                                                Tolak
                                                            </a>
                                                        <?php }else if($a->flags == 1){?>
                                                          <a class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#switchNonAktif" data-id="<?=$a->idriwayat_pinjaman?>">
